...
if os.path.isfile('./checkpoints/2023_Mutli_Query_Attn.pt'):
    model.load_state_dict(torch.load('./checkpoints/2023_Mutli_Query_Attn.pt'))
...
for epoch in range(N_EPOCHS):
    ...
    if train_loss < best_epoch_loss:
        ...
        torch.save(model.state_dict(), './checkpoints/2023_Mutli_Query_Attn.pt')
...
trained_model.load_state_dict(torch.load('./checkpoints/2023_Mutli_Query_Attn.pt'))
